...
//
// $_Id: menu.inc.php,v 1.8 2004/11/27 12:23:02 henoheno Exp $
//
// Copyright (C)
//   2009      ryu1k ( ryu1kkb_ATMARK_gmail_DOT_com )
//   200x      PukiWiki Developers Team
// License: GPL v2 or (at your option) any later version
//
// ChangeLog:
//   2009/03 Hide anchor in menubar.  ( ryu1k : ryu1kkb_ATMARK_gmail_DOT_com )
//
// ParaeditId: $Id: menu.inc.php,v 1.1 2012/03/19 18:21:25 yamazaki Exp $
// 
// ChangeLog:
//
...
function plugin_menu_convert()
{
	...
	if ($num > 0) {
		...
		if (! is_page($page)) {
			...
			return preg_replace('/<ul[^>]*>/', '<ul>', convert_html($menutext, 0));  
		}
	}
}
?>
