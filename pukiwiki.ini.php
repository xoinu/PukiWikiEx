...
// $Id: pukiwiki.ini.php,v 1.2 2012/03/20 00:48:42 yamazaki Exp $
// Copyright (C)
...
/////////////////////////////////////////////////
// Enable heading anchor based edit, aka paraedit.
//  Note for developpers: Paraedit internally use "id" as important key
//  which distinguish in paraedit mode or not.
$fixed_heading_anchor_edit = 1;

if (! defined('PKWK_PARAEDIT_ICON'))
	define('PKWK_PARAEDIT_ICON', '<span class="icon small" data-icon="7" title="Pencil"></span>');
