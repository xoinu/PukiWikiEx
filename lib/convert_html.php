...
// $_Id: convert_html.php,v 1.18 2006/05/13 07:29:58 henoheno Exp $
// Copyright (C)
//   2009      ryu1k ( ryu1kkb_ATMARK_gmail_DOT_com )
//   200x      Someone uploaded the patch for prior versions on PukiWiki-dev official site.
//    http://pukiwiki.sourceforge.jp/dev/?PukiWiki%2F1.4%2F%A4%C1%A4%E7%A4%C3%A4%C8%CA%D8%CD%F8%A4%CB%2F%B8%AB%BD%D0%A4%B7%A4%B4%A4%C8%A4%CE%CA%D4%BD%B8%28fixed_anchor%C8%C7%29
//   2002-2005 PukiWiki Developers Team
//   2001-2002 Originally written by yu-ji
// License: GPL v2 or (at your option) any later version
//
// ChangeLog:
//   2009/03 Hide anchor in menubar.
//   2009/03 Enable fixed_header_anchor_editing
//
// ParaeditId: $Id: convert_html.php,v 1.1 2012/03/19 18:21:25 yamazaki Exp $
//
...
function convert_html($lines, $is_use_anchor_given = 1)
{
	global $vars, $digest;
	static $contents_id = 0;

    global $_is_use_anchor;
    $_is_use_anchor = $is_use_anchor_given;
...
class TableCell extends Element
{
	...
	function toString()
	{
        ...
        $cell_str = $this->wrap(parent::toString(), 'iframe', ' class="pw-cell"');
        $cell_str = parent::toString();
		return $this->wrap($cell_str, $this->tag, $param, FALSE);
	}
}
	...
	function YTable($_value)
	{
		...
		for ($i = 0; $i < $count; $i++) {
			if ($colspan[$i]) {
				...
				$str .= '<td class="style_td"' . $align[$i] . $colspan[$i] . '><div class="pw-cell">' . make_link($value[$i]) . '</div></td>';
...
class Body extends Element
{
	...
	function getAnchor($text, $level)
	{
        ...
        global $fixed_heading_anchor_edit; // for paraedit:
        global $_is_use_anchor; // hide anchor in menubar
        ...
        if ($fixed_heading_anchor_edit) { $anchor .= " &edit(#$id,paraedit);"; } // for paraedit:
