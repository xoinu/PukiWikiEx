...
// $_Id: html.php,v 1.57 2006/04/15 17:33:35 teanan Exp $
// Copyright (C)
...
//
// ParaeditId: $Id: html.php,v 1.1 2012/03/19 18:21:25 yamazaki Exp $
//
...
EOD;
    ...
    $s_id        = isset($vars['id']) ? htmlspecialchars($vars['id']) : ''; // for paraedit
